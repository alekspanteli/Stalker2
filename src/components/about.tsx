      ...
      <div className="max-w-[1920px] mx-auto">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <button className="text-white font-medium text-lg flex items-center gap-3 group">
          ...
          >
            <Image
              src="https://images.unsplash.com/photo-1592367249429-e1760a50f750?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080"
              alt="Gas Mask"
              fill
