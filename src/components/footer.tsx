...
const SOCIAL_ICONS = [Twitter, Youtube, Facebook, Instagram, Twitch] as const;

const GAME_LINKS = ["Overview", "Features", "World", "Media"] as const;
const SUPPORT_LINKS = ["Help Center", "FAQ", "Contact", "Forums"] as const;
