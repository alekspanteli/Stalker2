  ...
  return (
    <>
      <div id="home" className="relative h-screen flex items-end justify-center overflow-hidden pb-24">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl">
          ...
          >
            ...
            <Button variant="outline" size="lg" onClick={() => setIsTrailerOpen(true)}>
              Watch Trailer
            </Button>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10 w-6 h-10 border-2 border-stalker-cream/30 flex justify-center pt-2"
        >
      ...
      <Lightbox
        ...
        embedUrl="https://www.youtube.com/embed/PKO4PL8Xzik?autoplay=1&rel=0"
        dialogTitle="S.T.A.L.K.E.R. 2 official trailer"
        dialogDescription="Watch the official S.T.A.L.K.E.R. 2 trailer in a dialog lightbox."
      />
    </>
  );
}
